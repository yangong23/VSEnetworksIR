...
def main():
    ...
    parser.add_argument('--embed_size', default=1024, type=int,
                        help='Dimensionality of the joint embedding.')#1024
    ...
    parser.add_argument('--img_dim', default=2048*36, type=int,
                        help='Dimensionality of the image embedding.')#4096
    parser.add_argument('--finetune', action='store_true',
                        help='Fine-tune the image encoder.')
    parser.add_argument('--cnn_type', default='resnet101',
                        help="""The CNN used for image encoder
                        (e.g. vgg19, resnet152)""") #vgg19
