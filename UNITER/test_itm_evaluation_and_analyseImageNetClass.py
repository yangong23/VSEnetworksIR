...
def main(opts):
    ...
    # eval_dataset_train = train_dataset
    train_img_db = all_img_dbs[opts.train_img_db]
    train_txt_db = TxtTokLmdb(opts.train_txt_db, -1)
    eval_dataset_train = ItmEvalDataset(train_txt_db, train_img_db,
                                        opts.inf_minibatch_size)
    eval_loader_train = build_dataloader(eval_dataset_train, itm_eval_collate,
                                         False, opts)
    ...
    for split, loader in [
        ...
        LOGGER.info(
            ...
            f"text retrieval R20: {eval_log['txt_r20'] * 100:.2f}")
    LOGGER.info("=========================================================")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", default="source", type=str,
    ...
    parser.add_argument("--inf_minibatch_size", default=20, type=int,
    ...
    parser.add_argument('--config', default="config/evaluation-itm-flickr-base-8gpu.json", help='JSON config files')
