...
# The code is modified to be used by VSEnetworksIR.
# -----------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    # if output_dir exist, delete it
    # output_dir_folder = os.path.abspath(os.path.join(os.path.dirname(args.output_dir), os.pardir))
    # if os.path.exists(output_dir_folder):
    #     for fileList in os.walk(output_dir_folder):
    #         for name in fileList[2]:
    #             os.chmod(os.path.join(fileList[0], name), stat.S_IWRITE)
    #             os.remove(os.path.join(fileList[0], name))
    #     shutil.rmtree(output_dir_folder)
    # if output_dir exist, add time
