...
Please note: (1) The title related to the ID of ImageNet class is shown in ImageNetClass_ID_Titles.txt which is uploaded in the root; (2) [Orignal Flickr30K images](http://shannon.cs.illinois.edu/DenotationGraph/) can also be downloaded for being analysed with retrieval result details.
